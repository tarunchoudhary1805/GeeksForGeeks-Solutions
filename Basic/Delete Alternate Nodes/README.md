<h2><a href="https://practice.geeksforgeeks.org/problems/delete-alternate-nodes/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Delete Alternate Nodes</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Singly Linked List of size <strong>N</strong>,&nbsp;delete all alternate nodes of the list.</span></p>
