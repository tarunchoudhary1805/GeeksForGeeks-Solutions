<h2><a href="https://practice.geeksforgeeks.org/problems/check-if-divisible-by-114724/0">Check if divisible by 11</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>S</strong>. Check whether it is divisble by 11 or not.</span></p>
